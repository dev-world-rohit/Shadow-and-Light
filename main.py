...
black_overlay = scale_image_size(load_image('black_background_overlay.png', 30), SCREEN_WIDTH, SCREEN_HEIGHT)
...
button_scale = 0.8
yellow_music_on_button = scale_image_ratio(load_image('buttons/yellow_buttons/yellow_music_on.png'), button_scale)
yellow_music_off_button = scale_image_ratio(load_image('buttons/yellow_buttons/yellow_music_off.png'), button_scale)
yellow_play_button = scale_image_ratio(load_image('buttons/yellow_buttons/yellow_play.png'), button_scale)
yellow_thumbs_up_button = scale_image_ratio(load_image('buttons/yellow_buttons/yellow_thumbs_up.png'), button_scale)
yellow_pause_button = scale_image_ratio(load_image('buttons/yellow_buttons/yellow_pause.png'), button_scale - 0.2)
yellow_replay_button = load_image('buttons/yellow_buttons/yellow_replay.png')
...
white_pause_button = scale_image_ratio(load_image('buttons/white_buttons/white_pause.png'), button_scale - 0.2)
white_replay_button = load_image('buttons/white_buttons/white_replay.png')
...
additional_buttons = {
    'pause': [yellow_pause_button, white_pause_button, [SCREEN_WIDTH - 50, 10]],
    'replay': [yellow_replay_button, white_replay_button, [(SCREEN_WIDTH - yellow_replay_button.get_width()) // 2,
                                                           (SCREEN_HEIGHT - yellow_replay_button.get_height()) // 2]]
}
...
def game_pause():
    ...
    while game:
        ...
        button = 'replay'
        button_data = additional_buttons[button]
        if (button_data[2][0] < mouse_pos[0] < button_data[2][0] + button_data[0].get_width() and button_data[2][1] <
                mouse_pos[1]
